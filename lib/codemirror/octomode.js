...
CodeMirror.defineMode('octo', function(config, options) {
	...
	const STATEMENTS = {
		...
		'pitch':1,'volume':1,'channel':1,'voice':1,'palette':1,'invert':1,
		'sprite-grab':1,'sprite-stamp':1,'sprite-erase':1,'sprite-toggle':1

	}
	const DIRECTIVES = {
		':alias':1, ':const':1, ':unpack':1, ':next':1, ':org':1,
		':byte':1, ':breakpoint':1, ':macro':1, ':calc':1, ':call':1, ':monitor':1,
		':stringmode':1, ':assert':1, ':pointer':1, ':offset':1,
		':shortbranch':1, ':longbranch':1, ':shortcomp':1, ':longcomp':1, 
	}
